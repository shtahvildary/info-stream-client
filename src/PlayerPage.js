...
class PlayerPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      channels: [{ name: 'شبکه یک', address: "http://172.16.16.153:8000/tv1.m3u8" }, { name: 'شبکه ورزش', address: "http://172.16.16.153:8000/varzesh.m3u8" },{ name: 'موزاییک', address: "http://172.16.16.153:8000/mosaic.m3u8" }],
