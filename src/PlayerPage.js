...
class PlayerPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      channels: [{id:1, name: 'شبکه یک', address: "http://62.220.122.5:8000/tv1.m3u8" },
      { id:2,name: 'شبکه دو', address: "http://62.220.122.5:8000/tv2.m3u8" },
      { id:3,name: 'شبکه سه', address: "http://62.220.122.5:8000/tv3.m3u8" },
      { id:4,name: 'شبکه چهار', address: "http://62.220.122.5:8000/tv4.m3u8" },
      { id:5,name: 'شبکه پنج', address: "http://62.220.122.5:8000/tv5.m3u8" },
      { id:6,name: 'شبکه آموزش', address: "http://62.220.122.5:8000/amoozesh.m3u8" },
      { id:7,name: 'شبکه قرآن', address: "http://62.220.122.5:8000/quran.m3u8" },
      { id:8,name: 'شبکه سلامت', address: "http://62.220.122.5:8000/salamat.m3u8" },
      { id:9,name: 'شبکه نسیم', address: "http://62.220.122.5:8000/nasim.m3u8" },
      { id:10,name: 'شبکه مستند HD', address: "http://62.220.122.5:8000/mostanad.m3u8" },
      { id:11,name: 'شبکه نمایش', address: "http://62.220.122.5:8000/namayesh.m3u8" },
      { id:12,name: 'شبکه افق', address: "http://62.220.122.5:8000/ofogh.m3u8" },
      { id:13,name: 'شبکه ورزش', address: "http://62.220.122.5:8000/varzesh.m3u8" },
      { id:14,name: 'شبکه پویا', address: "http://62.220.122.5:8000/pooya.m3u8" },
      { id:15,name: 'شبکه تماشا HD', address: "http://62.220.122.5:8000/tamasha.m3u8" },
      { id:16,name: 'شبکه سه HD', address: "http://62.220.122.5:8000/tv3HD.m3u8" },
      { id:17,name: 'شبکه امید', address: "http://62.220.122.5:8000/omid.m3u8" },
      { id:18,name: 'شبکه جام جم', address: "http://62.220.122.5:8000/jam_e_jam.m3u8" },
      { id:19,name: 'شبکه خبر', address: "http://62.220.122.5:8000/irinn.m3u8" },
      { id:20,name: 'شبکه ورزش', address: "http://62.220.122.5:8000/varzesh.m3u8" },
      { id:21,name: 'موزاییک', address: "http://62.220.122.5:8000/mosaic.m3u8" },
      { id:21,name: 'سیگنال خارجی', address: "http://62.220.122.5:8000/sdi.m3u8" }
    ],


     src: { name: "شبکه یک", address: "http://62.220.122.5:8000/tv1.m3u8" }
